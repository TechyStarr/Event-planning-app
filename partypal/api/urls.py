...
urlpatterns = [
    ...
    path('event/remove-guest/<int:event_id>/user/<int:user_id>/', views.RemoveGuest.as_view(), name='event-remove-guest'),
    path('event/guestlist/<int:pk>/', views.RetrieveEventGuestList.as_view(), name='event-guestlist'),
]
